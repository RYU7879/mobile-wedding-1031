[README.md](https://github.com/user-attachments/files/30923048/README.md)
# 류성길 & 형가희 모바일 청첩장
...
`music/wedding-bgm.mp3`에 배경음악이 들어 있습니다.

- 페이지가 열리면 자동재생을 시도합니다.
- 모바일 브라우저가 자동재생을 차단하면 첫 터치/클릭에서 재생을 시도합니다.
- 오른쪽 위 `♪ MUSIC` 버튼으로 켜고 끌 수 있습니다.
- 음원 파일을 바꾸려면 `music/wedding-bgm.mp3`를 같은 파일명으로 교체하면 됩니다.

### 저작권 주의
상업 음원은 공개 GitHub Pages에서 배포할 경우 별도의 이용 권리가 필요할 수 있습니다. 실제 청첩장 공개 전에 음원의 온라인 배포/웹 사용 권한을 확인하세요.
